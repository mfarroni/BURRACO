            ...
            <svg className="hero-scene" viewBox="0 0 640 360" preserveAspectRatio="xMidYMid slice">
              <defs>
                <radialGradient id="lp-felt-fused" cx="50%" cy="50%" r="65%">
                  ...
                  <stop offset="55%" stopColor="#174a38" stopOpacity="0.92" />
                  <stop offset="85%" stopColor="#0e2a22" stopOpacity="0.4" />
              ...
              <rect x="0" y="0" width="640" height="360" fill="url(#lp-felt-fused)" />
